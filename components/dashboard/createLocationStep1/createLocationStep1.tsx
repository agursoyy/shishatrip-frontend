...
import './createLocationStep1.scss';
import { useDispatch, useSelector } from 'react-redux';
import { RootState } from '../../../stores';
import { removeCafePhoto, uploadCafePhoto } from '../../../stores/create-location-form/actions';
...
const Step1: FC<IProps> = ({ headerForm, profileSection, setProfileSection }) => {
  ...
  return (
    <div className="location-form-step1">
      {/* navbar */}
                ...
                if (e.target.files) {
                  ...
                  if (file) {
                    ...
                    reader.onload = function () {
                      if (reader.result) {
                        dispatch(uploadCafePhoto(reader.result.toString()));
                      }
                    };
                  }
                }
      ...
      <div className="location-step-btn-wrapper d-flex justify-content-end">
        <button
